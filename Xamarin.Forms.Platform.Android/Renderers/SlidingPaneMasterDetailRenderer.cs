...
{
	public class SlidingPaneMasterDetailRenderer : SlidingPaneLayout, IVisualElementRenderer, SlidingPaneLayout.IPanelSlideListener
    {
		...
		public SlidingPaneMasterDetailRenderer() : base(Forms.Context)
		{
		}
