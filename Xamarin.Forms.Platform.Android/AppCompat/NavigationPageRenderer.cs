...
namespace Xamarin.Forms.Platform.Android.AppCompat
{
    public class NavigationPageRenderer : VisualElementRenderer<NavigationPage>, IManageFragments, IOnClickListener
    {
        ...
        {
            if (_slidePanelRenderer != null)
            {
                bool isNavigated = ((INavigationPageController)Element).StackDepth > 1;

                if (!isNavigated)
                {
                    _slidePanelRenderer.Presented = !_slidePanelRenderer.Presented;
...
#pragma warning restore 1998
        ...
        private SlidingPaneMasterDetailPageRenderer _slidePanelRenderer;
        ...
        void RegisterToolbar()
        {
            ...
            var slidePanelRenderer = Android.Platform.GetRenderer(masterDetailPage) as SlidingPaneMasterDetailPageRenderer;
            if (slidePanelRenderer != null)
            {
                _slidePanelRenderer = slidePanelRenderer;
            }
        }
